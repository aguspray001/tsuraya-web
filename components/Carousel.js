...
const Carousel = () => {
    return (
        <>
        <div className="relative rounded-lg block md:flex items-center bg-gray-100 shadow-xl w-10/12" style={{minHeight: '19rem'}}>
            <div className="relative w-full md:w-2/5 h-full overflow-hidden rounded-t-lg md:rounded-t-none md:rounded-l-lg" style={{minHeight: '19rem'}}>
                <p className="p-2 absolute z-10 text-white">#Build the things easily</p>
                <div className="absolute inset-0 w-full h-full flex fill-current text-white">
                <Image src={catalogOne} alt="daed" className="bg-contain bg-no-repeat bg-center" />
                </div>
            </div>
            <div className="w-full md:w-3/5 h-full flex items-center bg-gray-100 rounded-lg">
                <div className="p-12 md:pr-24 md:pl-16 md:py-12">
                <p className="text-gray-600">
                    <span className="text-gray-900">Project | Perumahan Pungging, Mojokerto</span>
                </p>
